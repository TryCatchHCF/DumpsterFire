...
class nmap_subnet_smb_probes( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_subnet_smb_probes"
		return
	...
	def Description( self ):
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sV -p139,445 --script=smb-os-discovery,smb-system-info,smb-enum-users,smb-enum-shares " + self.networkAddrStr + "/24" 
