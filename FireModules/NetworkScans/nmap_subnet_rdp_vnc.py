...
class nmap_subnet_rdp_vnc( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_subnet_rdp_vnc"
	...
	def Description( self ):
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sV -p3389,5900 " + self.networkAddrStr + "/24" 
