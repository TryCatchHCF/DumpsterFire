...
class nmap_subnet_top_1000_and_probes( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_subnet_top_1000_and_probes"
		return
	...
	def Description( self ):
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -sC " + self.networkAddrStr + "/24"
