...
class nmap_subnet_top_80_quiet( FireModule ):

	def __init__(self):
		self.commentsStr = "NetworkScans/nmap_subnet_top_80_quiet"
		return
	...
	def Description( self ):
        ...
        def Ignite( self ):
			...
			self.commandStr = "nmap -Pn -n --open -sT -T2 --top-ports=80 " + self.networkAddrStr + "/24"
